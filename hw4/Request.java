...
public class Request {
	/**
	 * implement the Request class, which should include the necessary information
	 * to do statistics over all the requests. e.g., to calculate Tq, one needs to
	 * record the arrival time, and finish time of the request
	 */
	private int requestId;
	private double systemArrival;
	...
	public void setSystemArrTime(double time) {
		systemArrival = time;
	}
	
	public double getSystemArr() {
